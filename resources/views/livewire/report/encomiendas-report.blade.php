        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-2 p-2 shadow-xl">
            ...
            <div>
                <x-mary-select label="Estado" icon="s-inbox-stack" :options="$estados"
                    wire:model.live="FiltroEstadoEncomienda" />
            </div>
            <div>
                        ...
                        @scope('cell_estado', $stuff)
                            <div class="flex items-center">
                                <div class="ml-2">
                                    ...
                                    <p class="font-medium bg-{{ $stuff->isActive ? 'green' : 'red' }}-500 text-white px-2 py-1 rounded-md">{{ $stuff->isActive ? 'Activo' : 'Anulado' }}</p>
                                </div>
                            </div>
                        @endscope
